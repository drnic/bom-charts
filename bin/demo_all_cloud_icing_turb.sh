...
# Usage:
# bin/demo_all_cloud_icing_turb.sh
# bin/demo_all_cloud_icing_turb.sh | grep '"parsed":{}'
...
#
# Some text represents important cumulus activity:
# {"text":"OCNL TCU 2500/ABV10000FT","parsed":{"cumulus":{"amount":"OCNL","type":"TCU","base":2500,"top":10000}}}
